...
const labels = {
  en: {
    ...
    view: "View",
    download: "Download",
    none: "No transfer orders available currently.",
    loading: "Loading…",
  ...
  mr: {
    ...
    view: "पहा",
    download: "डाउनलोड",
    none: "सध्या कोणतेही बदली आदेश उपलब्ध नाहीत.",
    loading: "लोड होत आहे…",
    error: "लोड करता आले नाही.",
  },
};
...
export default function TransfersOrders() {
  ...
  const { data: orders = [], isLoading, error } = useQuery({
    queryKey: ["public", "transfer_orders"],
              ...
              <tbody>
                {orders.map((order, index) => (
                  ...
                  >
                    ...
                    <td className="border border-gray-300 px-3 py-2">{formatDate(order.published_date, lang)}</td>
                    <td className="border border-gray-300 px-3 py-2 text-left">
                      {lang === "mr" ? order.title_mr : order.title_en}
                    </td>
